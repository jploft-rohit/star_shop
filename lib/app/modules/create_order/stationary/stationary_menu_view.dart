...
class StationaryMenuView extends GetView<StationaryMenuController>{
  int? type;
   StationaryMenuView({super.key,this.type});
                    ...
                    child: Column(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.asset(type==0?
                            'assets/images/im_stationary_0${index+1}.png':'assets/images/im_stars_store_0${index+1}.png',
                            height: 20.h,
