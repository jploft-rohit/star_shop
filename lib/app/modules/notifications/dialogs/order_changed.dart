...
class OrderChangedDialog extends GetView<NotificationController>{
  const OrderChangedDialog({super.key});
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  addText('Order Changed', getSubheadingTextFontSIze(),
                ...
                children: [
                  ...
                  Flexible(
                    child: GestureDetector(
                      ...
                      child: EdgyBorderedButton(width: 43.w, text: 'LATE TO CHANGE'),
                    ),
                  )
                ],
              ),
  ...
  Widget buildInfo(){
    return  RichText(
      ...
      text: TextSpan(
        children: [
          TextSpan(
              text: "Order item Changed by the User Lunchbox Removed and Mango Juice added to the order ".tr,
              style: TextStyle(
                fontFamily: 'Ariel',
