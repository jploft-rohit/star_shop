...
class OrderStarStoreView extends GetView<OrderStarStoreController>{
  const OrderStarStoreView({super.key});
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () {
                    if(Get.find<OrdersController>().tabController?.index == 3 && controller.selectedTypePos.value == 3){
