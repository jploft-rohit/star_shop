...
class ReturnedOrderItemsView extends GetView<OrdersController>{
  const ReturnedOrderItemsView({super.key});
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              buildInfoItems('Order ID', '#45689 (First Break)'),
              SizedBox(height: 1.h,),
              ListView.builder(
                itemCount: 2,
              ...
              SizedBox(height: 1.h,),
              buildAmount('Shipping Charges', '10 AED'),
              SizedBox(height: 1.h,),
              buildAmount('Grand Total', '19 AED'),
              SizedBox(height: 1.h,),
              buildAmount('Refund Amount', '60 AED'),
              SizedBox(height: 3.h,),
              Container(
                width: 100.w,
                padding: const EdgeInsets.all(20),
                ...
                children: [
                  ...
                  SizedBox(height: 2.h,),
                  buildOrderDetailItem('Order Placed', 'July 3, 10:30AM'),
                  SizedBox(height: 1.h,),
                  buildOrderDetailItem('Packed', 'July 3, 10:30AM'),
                  SizedBox(height: 1.h,),
                  buildOrderDetailItem('Out for Delivery', 'July 3, 10:30AM'),
                  SizedBox(height: 1.h,),
                  buildOrderDetailItem('Delivered', 'July 3, 10:30AM'),
                ],
              ),
              ),
              SizedBox(height: 2.h,),
              Center(
                child: GestureDetector(
                  onTap: (){
                    ...
                    Get.dialog(const SuccessDialog(message: 'Are you sure to refund amount of 60 AED to user on order returned.',buttonText: 'CONFIRM',));
                    
                  },
                  child: BorderedButton(width: 20.w, text: 'ACCEPT RETURN',borderRadius: getCustomBorderRadius(15),),
                ),
              )
