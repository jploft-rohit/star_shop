...
class OrderStationaryView extends GetView<OrderStarStoreController>{
  const OrderStationaryView({super.key});
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () {
                    ...
                    if(Get.find<OrdersController>().tabController?.index == 1 && controller.selectedTypePos.value == 3){
                        ...
                        if (controller.selectedTypePos.value == 1)
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: ColorConstants.primaryColorLight,
                                borderRadius: getCurvedBorderRadius()
                            ), child: addText('COMPLETED', getSmallestTextFontSIze(), ColorConstants.primaryColor, FontWeight.bold),
                          ),
                        ...
                        if (controller.selectedTypePos.value == 2)
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: ColorConstants.primaryColorLight,
                                borderRadius: getCurvedBorderRadius()
                            ), child: addText('CANCELLED', getSmallestTextFontSIze(), ColorConstants.primaryColor, FontWeight.bold),
                          ),
