                      ...
                      return GestureDetector(
                        ...
                        child: Obx(
                            ...
                            decoration: BoxDecoration(
                                color: controller.parentsFilterSelectedPos.value == index ? ColorConstants.primaryColorLight : ColorConstants.white,
                                boxShadow:controller.parentsFilterSelectedPos.value == index ?  [getDeepBoxShadow()] : null,
                                border: controller.parentsFilterSelectedPos.value == index ? Border.all(color: ColorConstants.primaryColor,width: 1.5) : Border.all(color: ColorConstants.borderColor2,width: 1.5),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  addText((index+1).toString(), getSubheadingTextFontSIze(), controller.parentsFilterSelectedPos.value == index ? ColorConstants.primaryColor : ColorConstants.black, FontWeight.bold),
                                  const SizedBox(width: 2,),
                                  Image.asset('assets/images/star.png',height: getLargeTextFontSIze(),color: controller.parentsFilterSelectedPos.value == index ? null : ColorConstants.primaryColor.withOpacity(0.5),)
                                ],
                              ),
                            ),
                          ),
