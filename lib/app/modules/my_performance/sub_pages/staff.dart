                      ...
                      return GestureDetector(
                        ...
                        child: Obx(
                            ...
                            decoration: BoxDecoration(
                                color: controller.staffFilterSelectedPos.value == index ? ColorConstants.primaryColorLight : ColorConstants.white,
                                boxShadow:controller.staffFilterSelectedPos.value == index ?  [getDeepBoxShadow()] : null,
                                border: controller.staffFilterSelectedPos.value == index ? Border.all(color: ColorConstants.primaryColor,width: 1.5) : Border.all(color: ColorConstants.borderColor2,width: 1.5),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  addText((index+1).toString(), getSubheadingTextFontSIze(), controller.staffFilterSelectedPos.value == index ? ColorConstants.primaryColor : ColorConstants.black, FontWeight.bold),
                                  const SizedBox(width: 2,),
                                  Image.asset('assets/images/star.png',height: getLargeTextFontSIze(),color: controller.staffFilterSelectedPos.value == index ? null : ColorConstants.primaryColor.withOpacity(0.5),)
                                ],
                              ),
                            ),
                          ),
