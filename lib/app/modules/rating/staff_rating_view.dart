...
class StaffRatingView extends GetView<RatingController>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(preferredSize: Size.fromHeight(5.h), child:  AppHeader(showBackIcon: true, title: 'Staff Rating',)),
      body: Padding(
        ...
        child: Column(
          children: [
            Container(
              ...
              child: buildSchoolDropDown(controller.driverItems, controller.selectedDriver, 'Select Staff', 100.w),
            ),
            SizedBox(height: 2.h,),
            Container(
              decoration: BoxDecoration(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    buildInfoItems('Designation', 'Head Master'),
