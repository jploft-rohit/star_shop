...
class BusRatingView extends GetView<RatingController>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(preferredSize: Size.fromHeight(5.h), child:  AppHeader(showBackIcon: true, title: 'Bus Rating',)),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Obx(() => controller.isMinBusRating.value ? addText('Note - Comment is mandatory if you rate minimum', getSmallTextFontSIze(), ColorConstants.lightTextColor, FontWeight.normal) : const SizedBox.shrink()),
            SizedBox(height: 2.h,),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 10),
              decoration: getEditTextDecoration(),
              child: buildLineEditText(controller.busTextEditingController!, 'Comment :'),
            ),
            SizedBox(height: 3.h,),
            Row(
