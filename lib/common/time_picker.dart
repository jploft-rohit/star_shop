    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          controls,
          isShowdate?Container(child: VerticalDivider(thickness: 1,width: 1,),height: 30,):SizedBox.shrink(),
          isShowdate?Container(child: Text("${DateFormat('EEEE, dd MMM yyyy').format(DateTime.now())}",style: TextStyle(color: ColorConstants.primaryColor,fontWeight: FontWeight.w700,fontSize: 15.sp),),alignment: Alignment.center,):SizedBox.shrink(),
        ],
      ),
    );
  }
